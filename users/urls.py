...
from questions.views import recent_questions_view
app_name = 'users'
urlpatterns = [
    path('home/', recent_questions_view, name='home'),
    path('register/', user_register_view, name='register'),
    path('login/', user_login_view, name='login'),
    path('logout/', user_logout_view, name='logout'),
    path('profile/<int:uid>', user_profile_view, name='profile'),
    path('profile/edit//<int:uid>', user_profile_edit_view, name='profile_edit'),
]
